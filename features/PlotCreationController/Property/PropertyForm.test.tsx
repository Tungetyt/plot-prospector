...
describe('PropertyForm', () => {
  ...
  test('renders PropertyForm component', () => {
    ...
    expect(screen.getByRole('heading', {name: Index.Property})).toBeDefined()
  })
  ...
  test('fills out the form and submits', async () => {
    ...
    const description = screen.getByRole('textbox', {
      name: Index.Property_Description
    }) as HTMLInputElement
    const address = screen.getByRole('textbox', {
      name: Index.Property_Address
    }) as HTMLInputElement
  ...
  test('validates maximum price value', async () => {
    ...
    const priceInput = screen.getByRole('textbox', {name: Index.Property_Price})
